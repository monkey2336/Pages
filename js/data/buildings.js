...
(function (G) {
  ...
  var BUILDINGS = [
    ...
    B({ key: 'barracks', name: 'Barracks', cat: 'army', art: 'barracks', res: 'elixir', unlockTH: 1, size: 3,
        ...
        counts: [[1, 1], [2, 2], [4, 3], [8, 4]],
        desc: 'Trains elixir troops. Higher levels unlock deeper roster.' }),
    B({ key: 'darkbarracks', name: 'Dark Barracks', cat: 'army', art: 'darkbarracks', res: 'elixir', unlockTH: 7, size: 3,
        baseCost: 200000, baseTime: 3 * HOUR,
        counts: [[7, 1], [9, 2], [12, 3]],
        desc: 'Trains dark elixir troops.' }),
    ...
    B({ key: 'laboratory', name: 'Laboratory', cat: 'army', art: 'lab', res: 'elixir', unlockTH: 4, size: 3,
        baseCost: 5000, baseTime: 2 * HOUR,
