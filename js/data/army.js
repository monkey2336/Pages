...
(function (G) {
  ...
  var TROOPS = [
    ...
    { key: 'marauder', name: 'Marauder', res: 'dark', housing: 2, unlockTH: 3, role: 'Fast ground, targets dark elixir storage', dps: 30, hp: 150, speed: 32, targets: 'ground', prefers: 'resources', labCost: 8000, labTime: 6 * HOUR, art: 'marauder', tint: '#a49bb4' },
    { key: 'hogback', name: 'Hogback', res: 'dark', housing: 5, unlockTH: 4, role: 'Jumps walls, targets defenses', dps: 60, hp: 550, speed: 24, targets: 'ground', prefers: 'defenses', jumpsWalls: true, labCost: 12000, labTime: 8 * HOUR, art: 'hogback', tint: '#b57a52' },
    { key: 'witchling', name: 'Witchling', res: 'dark', housing: 8, unlockTH: 5, role: 'Revives fallen troops once', dps: 40, hp: 320, speed: 12, targets: 'ground', prefers: 'any', labCost: 20000, labTime: 12 * HOUR, art: 'witchling', tint: '#8f7fd8' },
    { key: 'nightstalker', name: 'Nightstalker', res: 'dark', housing: 10, unlockTH: 6, role: 'Invisible until it attacks', dps: 130, hp: 700, speed: 24, targets: 'ground', prefers: 'defenses', labCost: 28000, labTime: 14 * HOUR, art: 'nightstalker', tint: '#5de0c0' },
    { key: 'ravager', name: 'Ravager', res: 'dark', housing: 15, unlockTH: 7, role: 'Damage increases as it loses HP', dps: 100, hp: 2400, speed: 16, targets: 'ground', prefers: 'any', labCost: 40000, labTime: 18 * HOUR, art: 'ravager', tint: '#ff5a2b' },
    { key: 'hexweaver', name: 'Hexweaver', res: 'dark', housing: 18, unlockTH: 9, role: 'Disables one defense for 12s', dps: 70, hp: 1500, speed: 14, targets: 'ground', prefers: 'defenses', labCost: 55000, labTime: DAY, art: 'hexweaver', tint: '#a05cff' },
    { key: 'bonedrake', name: 'Bone Drake', res: 'dark', housing: 20, unlockTH: 11, role: 'Air, leaves damaging pools on death', dps: 180, hp: 2600, speed: 16, targets: 'both', prefers: 'any', air: true, labCost: 70000, labTime: 30 * HOUR, art: 'bonedrake', tint: '#c8ccd8' },
